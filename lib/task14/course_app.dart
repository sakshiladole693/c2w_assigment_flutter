import 'package:c2w_assignment_task/task14/design_page.dart';
  ...
  List<Map> courseList = [
    {
      ...
      'imgPath': 'assets/task14/svg/poster1.svg',
    },
    {
      'bgColor': [Color.fromRGBO(0, 77, 228, 1), Color.fromRGBO(1, 47, 135, 1)],
      'headingText': 'Design Thinking \nThe Beginner',
      'imgPath': 'assets/task14/svg/poster2.svg',
    },
  ];
  List<Map> categoryList = [
    {'img': 'assets/task14/svg/uiux.svg', 'textCategory': 'UI/UX'},
    {'img': 'assets/task14/svg/visual.svg', 'textCategory': 'VISUAL'},
    {'img': 'assets/task14/svg/illutration.svg', 'textCategory': 'ILLUTRATION'},
    {'img': 'assets/task14/svg/photo.svg', 'textCategory': 'PHOTO'},
  ];
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      SvgPicture.asset("assets/task14/svg/menu.svg"),
                      SvgPicture.asset("assets/task14/svg/bell.svg"),
                    ],
                  ),
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          ...
                          suffixIcon: SvgPicture.asset("assets/task14/svg/search.svg"),
                        ),
                      ),
                    ),
                  ),
